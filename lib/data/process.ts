...
const processStepsEs: ProcessStep[] = [
  {
    id: "discover",
    title: "Descubrir",
    description:
...
export function getProcessSteps(locale: "es" | "en"): ProcessStep[] {
