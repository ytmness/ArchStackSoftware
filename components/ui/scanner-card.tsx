...
export function ScannerCard({
  ...
  return (
    ...
    >
      ...
      >
        <div
          className="pointer-events-none absolute inset-0 rounded-2xl bg-gradient-to-br from-sky-950/40 to-blue-950/30"
          aria-hidden
        />

        <div
          className="card-ascii absolute inset-0 z-[1] overflow-hidden rounded-2xl border border-sky-500/25 bg-[#020408]"
          style={{
        ...
        >
          <div
            ...
            style={{
              backgroundImage:
                "repeating-linear-gradient(0deg, transparent, transparent 2px, rgba(56,189,248,0.35) 2px, rgba(56,189,248,0.35) 3px)",
            }}
            aria-hidden
          />
          <pre
            ref={preRef}
            className="ascii-content absolute inset-0 m-0 h-full w-full overflow-hidden whitespace-pre p-0 font-mono text-sky-300/85"
            style={{
        ...
        >
          ...
          <p className="absolute bottom-4 left-4 rounded-full border border-sky-400/35 bg-bg/75 px-3 py-1 text-xs text-sky-200 backdrop-blur-sm">
            {label}
          </p>
        </div>
      </div>
