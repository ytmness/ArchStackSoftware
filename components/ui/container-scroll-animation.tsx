    ...
    <div className="relative mx-auto mt-8 max-w-5xl pb-10 md:mt-10 md:pb-14">
      <motion.div
        style={{
          ...
          boxShadow:
            "0 0 0 1px rgba(250,204,21,0.22), 0 30px 70px -12px rgba(0,0,0,0.65), 0 50px 100px -24px rgba(234,179,8,0.28)",
        }}
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute -bottom-3 left-1/2 z-0 h-px w-[72%] -translate-x-1/2 bg-gradient-to-r from-transparent via-yellow-400/40 to-transparent md:-bottom-4"
      />
    </div>
  );
}
